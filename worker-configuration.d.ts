/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0307e626c80ff85386128f040385c8be)
// Runtime types generated with workerd@1.20260401.1 2025-04-10
declare namespace Cloudflare {
	...
	interface Env {
		...
		NUKI_API_KEY: string;
		AUTH_KEY: string;
		DOOR_OPEN_WORKFLOW: Workflow<Parameters<import("./src/index").DoorOpenWorkflow['run']>[0]['payload']>;
	}
}
