// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 10c62b08e85c7cb4acf82b10acd787d9)
...
declare namespace Cloudflare {
	interface Env {
		...
		NUKI_API_KEY: string;
		AUTH_KEY: string;
		DOOR_OPENER: DurableObjectNamespace<import("./src/index").DoorOpener>;
	}
}
